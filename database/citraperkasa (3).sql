...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Nov 2025 pada 12.25
...
--
-- Database: ` bona6213_citraperkasatour`
--
...
INSERT INTO `booking` (`id`, `booking_code`, `name`, `phone`, `email`, `destination_id`, `location_id`, `travel_date`, `pax`, `transport`, `accommodation`, `meal`, `note`, `estimated_price`, `status`, `details`, `created_at`) VALUES
...
(2, 'CP251103ADEC', 'Agus', '081333452810', '', 6, 10, '2025-11-01', 2, 'Minibus (6-7) pax', 'Homestay', 'Makan Besar (Buffet)', 'Aman', '2000000.00', 'new', '{\"locations\":[\"Sunrise Point\",\"Pasir Berbisik \\/ Pusung Gedhe\",\"Lembah Watangan\",\"Kawah Bromo\"],\"note\":\"Aman\"}', '2025-11-03 10:33:13'),
(3, 'CP251103D51E', 'Umum', '-', '-', 6, 11, '2025-11-29', 2, 'Bus Pariwisata (2-2 seat)', 'Hotel 2-4 orang/kamar', 'Makan Besar (Buffet)', '', '3000000.00', 'new', '{\"locations\":[\"Pasir Berbisik \\/ Pusung Gedhe\"],\"note\":\"\"}', '2025-11-03 10:59:53');
...
(3, 'BALI', 'PAKET WISATA KE BALI 3 HARI 3 MALAM', 'Harga yang kami tawarkan untuk Paket Wisata Bali dimulai dari Rp. 1,450,000, dengan ketentuan sebagai berikut : harga bervariasi tergantung dari obyek yang dipilih untuk Paket Bali maksimal memilih 5 obyek wisata (belum bermasuk tempat oleh-oleh) Harga juga ditentukan oleh jumlah orang yang berwisata', 'bali.png', '500000.00', '2025-11-03 09:38:37'),
(4, 'BROMO-MALANG', 'BROMO-MALANG 2 HARI 1 MALAM', 'Harga yang kami tawarkan untuk Paket Bromo-Malang dimulai dari Rp. 1,300,000, dengan ketentuan sebagai berikut : harga bervariasi tergantung dari obyek yang dipilih untuk Paket Bromo-Malang maksimal memilih 5 obyek wisata (belum bermasuk tempat oleh-oleh) Harga juga ditentukan oleh jumlah orang yang berwisata', 'bromo.png', '500000.00', '2025-11-03 09:40:10'),
(5, 'BANDUNG', 'BANDUNG 3 DAYS TRANSIT', 'Tiket masuk obyek wisata Sudah termasuk biaya parkir, biaya Tol, dan fee crew', 'bandung.png', '500000.00', '2025-11-03 09:42:54'),
(6, 'BROMO GILI KETAPANG', 'BROMO GILI KETAPANG 2 DAYS 1 NIGHT', 'Harga yang kami tawarkan untuk Paket Bromo-Gili Ketapang dimulai dari Rp. 1,300,000, dengan ketentuan sebagai berikut : \n\nharga bervariasi tergantung dari obyek yang dipilih\nHarga juga ditentukan oleh jumlah orang yang berwisata', 'bromogiliket.png', '500000.00', '2025-11-03 09:41:02');
...
INSERT INTO `gallery` (`id`, `type`, `title`, `desc`, `ufile`, `updated_at`) VALUES
(1, 'photo', 'Wisata', 'Laut', 'wisata.png', '2025-10-16 00:40:53'),
(2, 'photo', 'Ceria', 'Gunung', 'wisata2.png', '2025-10-16 00:40:53'),
(3, 'video', 'Instansi', 'Sekolah & Universitas', 'https://youtu.be/v9177akoLE0', '2025-10-16 00:40:53');
...
(10, 6, 'Sunrise Point', '', '100000.00'),
(11, 6, 'Pasir Berbisik / Pusung Gedhe', '', '100000.00'),
(12, 6, 'Lembah Watangan', '', '100000.00'),
(13, 6, 'Kawah Bromo', '', '100000.00'),
(14, 6, 'Snorkeling', '', '100000.00'),
(15, 6, 'Water Sport', '', '100000.00');
