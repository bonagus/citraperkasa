                    ...
                    <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#personalDetails" role="tab" aria-selected="false">
                                <i class="fas fa-home"></i> Tambah Review
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <?php
                    ...
                    if(ISSET($_POST['save'])){
                        ...
                        if($status=="OK"){
                            ...
                            if($qf){
                                $errormsg= "<div class='alert alert-success alert-dismissible alert-outline fade show'>Testimony has been added successfully.<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button></div>"; //printing error if found in validation
                            }
                            else{
                        ...
                        <div class="tab-pane active" id="personalDetails" role="tabpanel">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="firstnameInput" class="form-label">Review</label>
