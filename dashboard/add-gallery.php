            ...
            <div class="card">
                    ...
                    <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#personalDetails" role="tab" aria-selected="false">
                                <i class="fas fa-home"></i> Tambah Gallery
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <?php
                    ...
                    if(ISSET($_POST['save'])){
                        ...
                        $type = "photo";
                        if ( strlen($title) < 5 ){
                            $msg=$msg."Gallery Title Must Be More Than 5 Char Length.<BR>";
                            $status= "NOTOK";
                        }
                        if ( strlen($desc) > 50 ){
                            $msg=$msg."Gallery Text description Must Be Less Than 250 Char Length.<BR>";
                            $status= "NOTOK";
                        }
                        ...
                        if($status=="OK"){
                            $qb=mysqli_query($con,"INSERT INTO gallery (`type`, `title`, `desc` ,`ufile`) VALUES ('$type','$title', '$desc', '$new_file_name')");
                            if($qb){
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="firstnameInput" name="slide_title" placeholder="Enter Gallery Title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="firstnameInput" name="slide_text" placeholder="Enter Gallery Title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="hstack gap-2 justify-content-end">
                                            <button type="submit" name="save" class="btn btn-primary">Upload Gallery</button>
