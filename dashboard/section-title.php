            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Judul Section</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Konfigurasi</a></li>
                                <li class="breadcrumb-item active">Judul Section</li>
                            </ol>
                        </div>
            ...
            <div class="card">
                    ...
                    <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#personalDetails" role="tab" aria-selected="false">
                                <i class="fas fa-home"></i> Judul Section
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <?php
                    ...
                    if(ISSET($_POST['save'])){
                        ...
                        $dest_text = mysqli_real_escape_string($con,$_POST['dest_text']);
                        ...
                        */
                        ...
                        if($status=="OK"){
                            $qb=mysqli_query($con,"update section_title set about_title='$about_title', about_text='$about_text', why_title='$why_title',why_text='$why_text',service_title='$service_title',service_text='$service_text',dest_title='$dest_title',dest_text='$dest_text',test_title='$test_title',test_text='$test_text',contact_title='$contact_title',contact_text='$contact_text',enquiry_title='$enquiry_title',enquiry_text='$enquiry_text' where id=1");
                            if($qb){
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="firstnameInput" name="dest_title"  value="<?php print $dest_title ?>">
                                        </div>
                                    </div>

                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="firstnameInput" class="form-label"> Destination Text</label>
                                            <textarea class="form-control" id="exampleFormControlTextarea5" name="dest_text" rows="2"><?php print $dest_text ?></textarea>
                                        </div>
                                    </div>
