        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Booking Selesai</h4>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                    $q="SELECT b.id AS booking_id, b.booking_code, b.name AS customer_name, b.phone AS customer_phone, b.travel_date, b.pax, b.estimated_price, b.status, d.dest_title AS destination_name FROM booking b LEFT JOIN destination d ON b.destination_id = d.id WHERE b.status='confirmed' ORDER BY b.id DESC;";
                                            ...
                                            <td>
                                                <div class='dropdown d-inline-block'>
                                                    ...
                                                    <ul class='dropdown-menu dropdown-menu-end'>
                                                        ...
                                                        <li>
                                                            <a href='deletebooking.php?id=$id' onclick=\"return confirm('Yakin ingin menghapus pesanan ini?');\" class='dropdown-item text-danger'>
